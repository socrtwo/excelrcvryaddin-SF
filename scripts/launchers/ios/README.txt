Excel Recovery Add-in — iOS / iPadOS
============================

How to install (recommended)
----------------------------
Excel Recovery Add-in installs from Safari as a Progressive Web App.

1. Open Safari on your iPhone/iPad.
2. Visit:  https://socrtwo.github.io/excelrcvryaddin-SF/
...
Privacy
-------
Your .xlsx or .xls file never leaves your device; all processing happens locally
in Safari.
