...
Produces icon-192.png, icon-512.png, icon-maskable.png in web/. (Excel Recovery Add-in palette.)
"""
import os
import struct
import zlib
...
def gradient_rgba(size: int, c1=(6, 40, 26), c2=(22, 163, 74), accent=(34, 211, 238)) -> bytes:
